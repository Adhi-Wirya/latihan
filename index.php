...
<section>
    <div class="d-flex min-vh-100" lc-helper="background" style="background:url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCsCZhZXEGVZEMlom9fWKh7iSGCSyNFUwl1vEtALTHgF8nlGbnzaUBYh-vWz3gw8BSpKM&usqp=CAU)  center / cover no-repeat; background-color:#444; background-blend-mode: overlay;">
...
<section>
        <div class="py-2">
            <img src="./download.jpeg" alt="logo" class="mx-auto d-block">
